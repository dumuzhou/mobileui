import { isString, isObject, isFunction, capitalize, toCamelCase, internalComponents, isNumber, noop, isUndefined, isBoolean, hooks, ensure } from '../shared';
...
const hostConfig = {
    ...
    // -------------------
    // 鸿蒙平台不支持微任务
    supportsMicrotasks: "harmony" !== 'harmony',
