...
const Demo = function (p: DemoProps) {
  ...
  return withNativeProps(
    ...
    <View className={classnames(`${classPrefix}`)} {...restProps}>
      <View className={classnames(`${classPrefix}-gang`)}>
        <View className={classnames(`${classPrefix}-gang-start`)}></View>
        <View
          className={classnames(`${classPrefix}-gang-end`)}
          style={{}}
        ></View>
        <View className={classnames(`${classPrefix}-gang-point`)}></View>
      </View>
      <View className={classnames(`${classPrefix}-tips`)}>
        <Text className={classnames(`${classPrefix}-tips-text`)}>100%</Text>
      </View>
    </View>
  );
};
